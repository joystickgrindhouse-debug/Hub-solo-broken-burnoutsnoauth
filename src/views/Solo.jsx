...
export default function Solo({ user, userProfile }) {
  ...
  const drawSkeleton = (keypoints, canvas, quality = "neutral") => {
    ...
    // Dynamic color based on form
    const color = quality === "good" ? "#00ff00" : quality === "poor" ? "#ff2e2e" : "#00ff00";
    
    // Draw 3D-like depth effects using point size or shadow
    SKELETON_CONNECTIONS.forEach(([i, j]) => {
      ...
      if (start && end && (start.score >= MIN_POSE_CONFIDENCE || start.score === undefined)) {
        ...
        // Depth effect: thinner lines for farther points
        ...
        // Add corrective indicators (pulsing red for joints failing constraints)
        if (quality === "poor") {
