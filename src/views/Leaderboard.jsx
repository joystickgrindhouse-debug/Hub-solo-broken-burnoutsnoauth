...
// ✅ FIX: hero-background and overlay-card are custom CSS classes not defined in any
// uploaded stylesheet. Added inline style fallbacks so the page renders correctly
// even if the CSS file containing those classes is missing or not loaded.
...
export default function Leaderboard({ user }) {
  ...
  const aggregateScores = (scores) => {
    ...
    scores.forEach((scoreEntry) => {
      ...
      if (!userScores[userId]) {
        userScores[userId] = { userId, userName: scoreEntry.userName, totalScore: 0, gameScores: {} };
      }
    ...
    const arr = Object.values(userScores);
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ textAlign: "center", marginBottom: "1rem", fontSize: "22px", fontWeight: "bold" }}>Leaderboard</h2>
            ...
            {leaderboard.map((player, idx) => (
              <div
                ...
                style={{
                  ...
                  gap: "1rem",
                  padding: "1rem",
                  background: player.userId === user?.uid ? t.hoverBg : "rgba(255, 255, 255, 0.05)",
                  borderRadius: "8px",
