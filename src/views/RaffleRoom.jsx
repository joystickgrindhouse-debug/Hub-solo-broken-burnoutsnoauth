...
// ✅ FIX: ChatService was used in clearChat() but never imported → crash on admin button click
...
export default function RaffleRoom({ user, userProfile }) {
  ...
  return (
    <div className="hero-background" style={{ ...styles.container, background: "linear-gradient(180deg, #050505 0%, #0a0a0a 100%)" }}>
